...
export default function Beverage() {
  const items = [
    ...
    { type: "item", name: "MATCHA STRAWBERRY", price: "- - - / 25" },
    { type: "item", name: "RED COLD", price: "- - - / 25" },

    { type: "head", name: "NON COFFEE" },
    { type: "item", name: "CHOCO LATTE ", price: "20 / 24" },
    { type: "item", name: "CHOCO CARAMEL ", price: "24 / 25" },
    { type: "item", name: "CHOCO VANILLA ", price: "24 / 25" },
    { type: "item", name: "REDVELVET LATTE ", price: "20 / 24" },
    { type: "item", name: "TARO", price: "20 / 24" },
    { type: "item", name: "MATCHA LATTE ", price: "20 / 24" },
    { type: "item", name: "MILK HAZELNUT", price: "20 / 24" },
    { type: "item", name: "MILK VANILLA", price: "20 / 24" },
    { type: "item", name: "TEA ", price: "10 / 8" },
